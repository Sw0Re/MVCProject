...
namespace MVCProjeKampı.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public ActionResult Index(Admin p)
        {
            ...
            var adminuserinfo = c.Admins.FirstOrDefault(x => x.AdminUsername == p.AdminUsername && x.AdminPassword == password);
        ...
        public ActionResult WriterLogin(Writer p)
        {
            ...
            {
                return RedirectToAction("WriterLogin",writeruserinfo);
            }
        }
